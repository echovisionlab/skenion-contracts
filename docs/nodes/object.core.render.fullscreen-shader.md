...
`object.core.render.fullscreen-shader` runs a WGSL fullscreen pass and outputs a GPU texture resource.
...
```wgsl
// @skenion.uniform speed value.core.float32 default=0.5
