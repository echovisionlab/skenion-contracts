...
pub use v0_2::{
    ...
    PortGroupSpecV02, PortRateV02, PortSpecV02, TriggerModeV02, ValidationErrorV02,
    ValidationReportV02, analyze_graph_document_v02, validate_graph_document_v02,
    validate_node_definition_v02,
};
